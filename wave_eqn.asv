...
save(['ArQr_d',num2str(d),'_C_', num2str(C), '.mat'], 'ArQr');
save(['AlQl_d',num2str(d),'_C_', num2str(C), '.mat'], 'AlQl');
save(['ArQ_tilder_d',num2str(d),'_C_', num2str(C), '.mat'], 'ArQ_tilder');
save(['AlQ_tildel_d',num2str(d),'_C_', num2str(C), '.mat'], 'AlQ_tildel');
